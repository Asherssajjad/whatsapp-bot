  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-center text-primary-600 dark:text-primary-400 mb-2">WhatsApp Auto-Reply</h1>
        ...
        <p className="mt-3 text-center text-sm text-gray-500 dark:text-gray-400">
          <Link to="/demo" className="text-primary-600 hover:underline">View User Dashboard demo</Link>
          {' · '}
          <Link to="/demo/admin" className="text-amber-600 dark:text-amber-400 hover:underline">View Admin Dashboard demo</Link>
        </p>
      </div>
    </div>
  )
